        ...
        <div className="spacing-responsive h-full flex flex-col safe-area-padding">
          <div className="mb-6 sm:mb-8 lg:mb-10 pb-4 sm:pb-6 border-b border-white/30">
            <div className="flex items-center gap-3 sm:gap-4 mb-4">
              ...
              <div className="min-w-0 flex-1">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 truncate">Menu</h2>
                <p className="text-gray-600 text-xs sm:text-sm hidden sm:block">Navigate your workspace</p>
              </div>
            </div>
          </div>
          ...
          <nav className="space-y-2 sm:space-y-3 flex-1 hide-scrollbar-mobile overflow-y-auto">
            ...
            <button
              ...
              className="w-full text-left touch-target p-4 sm:p-5 hover:bg-white/30 rounded-xl sm:rounded-2xl font-semibold text-base sm:text-lg text-gray-700 hover:text-blue-600 transition-all duration-300 backdrop-blur-sm shadow-glass hover:shadow-glass-medium hover-lift group flex items-center gap-3 sm:gap-4"
            >
          ...
          <div className="pt-4 sm:pt-6 border-t border-white/30 mt-auto">
            <button
              onClick={handleExit}
              className="w-full bg-gradient-secondary text-white touch-target py-4 sm:py-5 px-4 sm:px-6 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:shadow-glow-strong transition-all duration-300 shadow-glass-medium border border-white/20 hover-lift group"
            >
              <div className="flex items-center justify-center gap-2 sm:gap-3">
                ...
                <span className="truncate">Exit App</span>
              </div>
            </button>
          </div>
        </div>
