...
const Input = forwardRef<HTMLInputElement, InputProps>(({
  ...
  return (
    <div className="w-full">
      {label && (
        <label className="font-body block text-sm font-medium text-white mb-2 drop-shadow-md">
          {label}
      ...
      />
      {error && (
        <p className="font-body mt-2 text-sm text-red-400 flex items-center gap-1 drop-shadow-md">
          {error}
        </p>
      )}
    </div>
